#ifndef VAPOR_CORE_BUS_H
#define VAPOR_CORE_BUS_H
...
typedef struct    vp_bus { u8_t bus[128]; } vp_bus;

bool_t vp_bus_in8  (vp_bus*, reg_t, u8_t*);
bool_t vp_bus_in16 (vp_bus*, reg_t, u8_t*);
bool_t vp_bus_in32 (vp_bus*, reg_t, u8_t*);
bool_t vp_bus_in64 (vp_bus*, reg_t, u8_t*);

bool_t vp_bus_out8 (vp_bus*, reg_t, u8_t*);
bool_t vp_bus_out16(vp_bus*, reg_t, u8_t*);
bool_t vp_bus_out32(vp_bus*, reg_t, u8_t*);
bool_t vp_bus_out64(vp_bus*, reg_t, u8_t*);
